...
# (str) Package name
package.name = CarParking

# (str) Package domain (needed for android/ios packaging)
package.domain = HrnyCats.CarParking
...
requirements = python3,kivy,kivymd,requests,certifi,urllib3,chardet,idna,plyer,https://github.com/kivymd/KivyMD/archive/master.zip,
    materialyoucolor,
    exceptiongroup,
    asyncgui,
    asynckivy
